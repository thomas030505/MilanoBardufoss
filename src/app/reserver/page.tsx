...
export const metadata: Metadata = {
  title: "Bordreservasjon midlertidig nede — Milano Bardufoss",
  description:
    "Bordreservasjon på nett er midlertidig utilgjengelig. Ring oss for å reservere bord.",
